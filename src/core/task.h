...
typedef struct {
	...
	uint32_t estimaed_time; ///< estimated time of execution
...
typedef struct {
	...
	task_callback resume; ///< pointer to resume function. This function is called when task status went from blocked to active status
